...
#ifndef DOCUMENT_H //Header guard (Protects against multiple inclusion)
#define DOCUMENT_H //Header guard
...
//For this project, a Document object is a linked list. It is made up of Lines (which are nodes)
